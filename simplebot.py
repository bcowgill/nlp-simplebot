...
def get_bot_response(user_input):
  ...
  except Exception as exception: # openai.error.InvalidRequestError:
    # openai.error.RateLimitError:
    bot_response = bot_response + "(" + type(exception).__name__ + ") [" + str(exception) + "]"
    # str(exception)
    # exception.__str__()
    # exception.__repr__()  -- more technical string representation
    # f"Arguments: {exception.args}"  array of strings for message
    # exception.__traceback__
    # exception.__cause__  None or ...
    # exception.__context__  None or ...
  else:
